...
import com.timepoorprogrammer.saml.impls.standard.consumer.processor.SAML11AssertionValidatorImpl;
import com.timepoorprogrammer.saml.common.FactoryBase;
import com.timepoorprogrammer.saml.impls.standard.consumer.processor.SAML11AssertionValidatorImpl;
...
/**
 * SAML11 Assertion validator factory.  As a SAML consumer, we may need to apply a bespoke validator for SAML11
 * assertion content sent from a remote identity provider.
 * <p/>
 ...
 * and is called SAML11AssertionValidatorImpl. If a bespoke processor isn't found then the factory
 ...
 * <li>Implement the SAML11AssertionValidator interface</li>
 * <li>Hold the class name SAML11AssertionValidatorImpl</li>
 * </ul>
 * <p/>
 ...
 * @author Jim Ball
 */
public class SAML11AssertionValidatorFactory extends FactoryBase {
    private static final Logger log = LoggerFactory.getLogger(SAML11AssertionValidatorFactory.class);

    /**
     * Bespoke SAML11AssertionValidators have to live in the consumer.processor subpackage of a
     * bespoke implementation.
     */
    private static final String BESPOKE_IMPL_SUB_PACKAGE_LOCATION = "consumer.processor";

    /**
     * As a SAML consumer, we may need to apply a custom assertion validator for SAML 1.1 content sent by a remote
     * identity provider.
     *
     * @param customerCode Customer code of identity provider within Northgate
     * @return instance of a SAML11AssertionValidator
     */
    @SuppressWarnings("unchecked")
    public static SAML11AssertionValidator getInstance(final String customerCode) {
        if (customerCode != null) {
            final List<String> details = parseClassName(SAML11AssertionValidator.class.getName());
            String fullPath = null;
            try {
                // If a customer needs a bespoke assertion validator, then we would need to create a
                ...
                return (SAML11AssertionValidator) implementation.newInstance();
                ...
                return new SAML11AssertionValidatorImpl();
