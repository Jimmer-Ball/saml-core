...
/**
 * SAML11 Assertion producer processor factory.  As a SAML producer, we may need to apply a bespoke processor for SAML
 ...
 * and is called SAML11AssertionProducerProcessorImpl. If a bespoke processor isn't found then the factory
 ...
 * <li>Implement the SAML11AssertionProducerProcessor interface</li>
 * <li>Hold the class name SAML11AssertionProducerProcessorImpl</li>
 * </ul>
 * <p/>
 ...
 * @author Jim Ball
 */
public class SAML11AssertionProducerProcessorFactory extends FactoryBase {
    private static final Logger log = LoggerFactory.getLogger(SAML11AssertionProducerProcessorFactory.class);

    /**
     * Bespoke SAML11AssertionProducerProcessors have to live in the producer.processor subpackage of
     ...
     * @param idpProtocol                 The SAML protocol we as identity provider use to create
     *                                    SAML messages, so SAMLConstant.SAML11P_NS == urn:oasis:names:tc:SAML:1.1:protocol
     ...
     * @return the correct implementation of a SAML11AssertionProducerProcessor
     */
    @SuppressWarnings("unchecked")
    public static SAML11AssertionProducerProcessor getInstance(final String metaDataFilePath,
                                                               final String idpId,
        ...
        if (spId != null && serviceCode != null) {
            final List<String> details = parseClassName(SAML11AssertionProducerProcessor.class.getName());
            ...
            try {
                ...
                return (SAML11AssertionProducerProcessor) constructor.newInstance(metaDataFilePath, idpId, idpProtocol,
                ...
                return new SAML11AssertionProducerProcessorImpl(metaDataFilePath, idpId, idpProtocol, serviceCode, spId,
            ...
            final String errorMessage = "Cannot look for a bespoke producer processor implementation as we've no target partner service provider";
