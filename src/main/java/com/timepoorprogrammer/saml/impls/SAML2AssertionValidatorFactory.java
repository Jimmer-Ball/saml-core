...
import com.timepoorprogrammer.saml.impls.standard.consumer.processor.SAML2AssertionValidatorImpl;
import com.timepoorprogrammer.saml.common.FactoryBase;
import com.timepoorprogrammer.saml.impls.standard.consumer.processor.SAML2AssertionValidatorImpl;
...
/**
 * SAML2 Assertion validator factory.  As a SAML consumer, we may need to apply a bespoke validator for SAML2
 ...
 * and is called SAML2AssertionValidatorImpl. If a bespoke processor isn't found then the factory
 ...
 * <li>Implement the SAML2AssertionValidator interface</li>
 * <li>Hold the class name SAML2AssertionValidatorImpl</li>
 * </ul>
 * <p/>
 ...
 * @author Jim Ball
 */
public class SAML2AssertionValidatorFactory extends FactoryBase {
    private static final Logger log = LoggerFactory.getLogger(SAML2AssertionValidatorFactory.class);

    /**
     * Bespoke SAML2AssertionValidators have to live in the consumer.processor subpackage of a
     * bespoke implementation.
     */
    private static final String BESPOKE_IMPL_SUB_PACKAGE_LOCATION = "consumer.processor";

    /**
     * As a SAML consumer, we may need to apply a custom assertion validator for SAML 2 content sent by a remote
     * identity provider.
     *
     * @param customerCode Customer code of identity provider within Northgate
     * @return instance of a SAML2AssertionValidator
     */
    @SuppressWarnings("unchecked")
    public static SAML2AssertionValidator getInstance(final String customerCode) {
        if (customerCode != null) {
            final List<String> details = parseClassName(SAML2AssertionValidator.class.getName());
            ...
            try {
                ...
                return (SAML2AssertionValidator) implementation.newInstance();
                ...
                return new SAML2AssertionValidatorImpl();
